...
import com.example.newsproject.TopHeadlineModel.everythingresponse.ArticlesItem
import com.squareup.picasso.Picasso
import kotlinx.android.synthetic.main.item.view.*

class EveryAdapter(val list: List<ArticlesItem>):
    RecyclerView.Adapter<EveryAdapter.UserViewHolder>() {
