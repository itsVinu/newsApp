...
import com.example.newsproject.Adapter.EntertainmentAdapter
import com.example.newsproject.Adapter.EveryAdapter
import com.example.newsproject.TopHeadlineModel.topheadlineentertainmentresponse.ArticlesItem
...
import kotlinx.android.synthetic.main.mainentertainment.*
...
class EntertainmentActivity : AppCompatActivity() , NavigationView.OnNavigationItemSelectedListener {
    ...
    val entertainmentadapter = EntertainmentAdapter(list)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        adView.adUnitId = "ca-app-pub-1351937667691042/7438150204"
        ...
        if (networkInfo != null && networkInfo.isConnected){
            GlobalScope.launch {
                val response = withContext(Dispatchers.IO) { Client.api.getTopHeadlinesEntertainment() }
